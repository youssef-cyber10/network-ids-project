"""Official NSL-KDD column names (41 network features + label + difficulty)."""
...
# Map each attack name to a top-level category (useful for analysis and display)
ATTACK_CATEGORY = {
    "normal": "normal",
    # DoS (حجب الخدمة)
    ...
    # Probe (استطلاع/فحص منافذ)
    "satan": "Probe", "ipsweep": "Probe", "nmap": "Probe", "portsweep": "Probe",
    "mscan": "Probe", "saint": "Probe",
    # R2L (وصول غير مصرح من بعيد)
